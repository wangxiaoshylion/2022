...
let sourceCode2 = `const sum = (a, b) => a + b`;
...
let targetSource = core.transform(sourceCode, {
  plugins: [namePlugin, arrowFunctionPlugin], //使用插件
});

let targetCode2 = core.transform(sourceCode2, {
  plugins: [namePlugin, arrowFunctionPlugin], //使用插件
});

console.log(targetSource.code, targetCode2.code);
